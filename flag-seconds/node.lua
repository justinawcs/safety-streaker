...
function node.render()
    ...
    black:write(32, 252, minutesSince.." Min, "..secsSince.." Sec", 150, 1,0,0,1)
    black:write(30, 250, minutesSince.." Min, "..secsSince.." Sec", 150, .3,0,0,1)
    ...
    black:write(xx+4, 604, streakDays.." Days", 180, 1,0,0,.6)
